    ...
    <h3 className={`ft-clr-3`}>Education</h3>
      <div className={`${styles.container} grid row-g-xs col-g-xl`}>
        ...
        <div className='col-6 mt-xs'>
          <p className=''>Through my academic journey, I acquired an in-depth understanding of market dynamics, including the factors that drive businesses and consumers, as well as the process of identifying supply and demand in real-world scenarios.
          </p>
          <p>
